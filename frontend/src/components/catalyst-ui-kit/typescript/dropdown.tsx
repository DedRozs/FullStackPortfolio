...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Text styles
    'text-left text-base/6 text-text-primary sm:text-sm/6 forced-colors:text-[CanvasText]',
    // Focus
    'data-focus:bg-brand-500 data-focus:text-white',
    // Disabled state
    ...
    '*:data-[slot=icon]:text-text-muted data-focus:*:data-[slot=icon]:text-white',
    // Avatar
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-text-muted sm:px-3 sm:text-xs/5'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-3.5 my-1 h-px border-0 bg-cyber-border sm:mx-3 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-text-muted group-data-focus:text-white sm:text-xs/5 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
    ...
    >
      {(Array.isArray(keys) ? keys : keys.split('')).map((char, index) => (
        <kbd
          key={index}
          className={clsx([
            'min-w-[2ch] text-center font-sans text-text-muted capitalize group-data-focus:text-white forced-colors:group-data-focus:text-[HighlightText]',
