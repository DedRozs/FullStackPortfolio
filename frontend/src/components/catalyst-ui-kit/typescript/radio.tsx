...
const base = [
  ...
  'before:absolute before:inset-0 before:-z-10 before:rounded-full before:bg-cyber-surface before:shadow-none',
  ...
  // Border
  'border border-cyber-border group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-neon-cyan/50 group-data-checked:bg-(--radio-checked-border)',
  'dark:border-white/15 dark:group-data-checked:border-white/5 dark:group-data-hover:group-data-checked:border-white/5 dark:group-data-hover:border-white/30',
  // Inner highlight shadow
  'after:absolute after:inset-0 after:rounded-full after:shadow-none',
  'dark:after:-inset-px dark:after:hidden dark:after:rounded-full dark:group-data-checked:after:block',
  // Indicator color
  '[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-neon-cyan)]/10',
  // Focus ring
  ...
  'group-data-disabled:border-cyber-border/50 group-data-disabled:bg-cyber-surface/50',
]
