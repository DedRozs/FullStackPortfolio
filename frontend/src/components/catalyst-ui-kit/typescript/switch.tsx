  ...
  return (
    <Headless.Switch
      ...
      className={clsx(
        ...
        // Unchecked
        'bg-cyber-elevated ring-1 ring-cyber-border ring-inset',
        // Checked
        ...
        // Hover
        'data-hover:ring-neon-cyan/30 data-hover:data-checked:ring-(--switch-bg-ring)',
        // Disabled
        'data-disabled:bg-cyber-elevated data-disabled:opacity-50 data-disabled:data-checked:bg-cyber-elevated data-disabled:data-checked:ring-cyber-border',
