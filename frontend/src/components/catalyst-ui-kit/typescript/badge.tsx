...
const colors = {
  ...
  'neon-cyan': 'bg-neon-cyan/15 text-neon-cyan group-data-hover:bg-neon-cyan/25',
  'neon-magenta': 'bg-neon-magenta/15 text-neon-magenta group-data-hover:bg-neon-magenta/25',
}
