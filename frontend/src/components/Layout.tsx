...
export default function Layout() {
  ...
  // Helper to determine if a path is current (handles exact match and nested routes)
  ...
  return (
    <>
      ...
      {/* Navigation */}
      <nav className="fixed top-0 w-full bg-dark-800/80 backdrop-blur-md border-b border-gray-800 z-50" aria-label="Main navigation">
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <Link 
              to="/" 
              className="text-xl font-semibold text-white hover:text-blue-400 transition"
              aria-label="Joseph Prince - Home"
            >
              Joseph Prince
            </Link>
        ...
        <div className="max-w-6xl mx-auto px-6 py-8">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-500 text-sm">
              &copy; 2026 Joseph Prince. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
