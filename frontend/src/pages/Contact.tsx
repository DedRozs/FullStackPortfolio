        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="max-w-2xl mx-auto">
            <div className="relative group">
              ...
              <div className="relative bg-dark-800/90 border border-green-800/50 rounded-2xl p-12 text-center" role="status" aria-live="polite">
                <div className="w-20 h-20 rounded-full bg-gradient-to-r from-green-500 to-teal-500 flex items-center justify-center mx-auto mb-6" aria-hidden="true">
              ...
              <div className="relative bg-dark-800/90 border border-gray-800 rounded-2xl p-8">
                {status === 'error' && (
                  <div
                    role="alert"
                    aria-live="assertive"
                    className="mb-6 p-4 bg-red-900/20 border border-red-800 rounded-xl text-red-400 flex items-center gap-3"
                  >
